...
$string['courseids_desc'] = 'Select courses where the floating button should appear. If no courses are enabled, it will not appear in any course.';
...
$string['showincoursesonly_desc'] = 'If off, the chat button will be available on all pages like home, dashboard, my courses, etc.';
