...
$string['addlticonfig'] = '+ Add';
$string['aiassessment'] = 'AI Assessment';
$string['aiassessment_desc'] = 'This allows the assistant to assist in assignment grading';
$string['aiops'] = 'Enable AI Ops';
$string['aiopsdisabled'] = 'AI Ops integration disabled';
$string['allowecourses'] = 'Allowed Courses';
$string['allowecoursesmatching'] = 'Allow courses matching {$a}';
$string['apidisabled'] = 'API disabled';
$string['assessmenthost'] = 'Host';
$string['assistantid'] = 'Assistant ID';
$string['checkpassauthheader'] = 'Authorization header check succeeded.';
...
$string['courseids_desc'] = 'Select the courses the floating button should appear in. This applies only when "Only show in courses" is enabled; if no courses are selected, the button will not appear in any course.';
$string['denycourses'] = 'Exclude Courses';
$string['denycoursesmatching'] = 'Exclude courses matching {$a}';
...
$string['mustneededauthheader'] = 'This test might indicate that the authentication header is being stripped away due to missing dependencies. Please contact support.';
$string['nolticonfigfound'] = 'No LTI configured';
...
$string['privacy:metadata:local_learnwise_accesstoken:token'] = 'The SHA-256 hash of the access token issued to the user.';
$string['privacy:metadata:local_learnwise_authcode'] = 'Information about the authorization codes issued to users.';
$string['privacy:metadata:local_learnwise_authcode:code'] = 'The SHA-256 hash of the authorization code issued to the user.';
...
$string['privacy:metadata:local_learnwise_refreshtoken:token'] = 'The SHA-256 hash of the refresh token issued to the user.';
...
$string['rotatetokenmodal_desc'] = 'Are you sure want to rotate Access Token?';
$string['rotatetokenmodal_no'] = 'Cancel';
$string['rotatetokenmodal_title'] = 'Rotate Access Token';
$string['rotatetokenmodal_yes'] = 'Confirm';
...
$string['showincoursesonly'] = 'Only show in courses';
$string['showincoursesonly_desc'] = 'When enabled, the floating button appears only in the courses selected below, and not on pages such as the home page, dashboard or my courses. When disabled, it appears on every page.';
