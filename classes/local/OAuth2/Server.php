...
namespace local_learnwise\local\OAuth2;

use local_learnwise\local\OAuth2\Controller\ResourceControllerInterface;
use local_learnwise\local\OAuth2\Controller\ResourceController;
use local_learnwise\local\OAuth2\OpenID\Controller\UserInfoControllerInterface;
use local_learnwise\local\OAuth2\OpenID\Controller\UserInfoController;
use local_learnwise\local\OAuth2\OpenID\Controller\AuthorizeController as OpenIDAuthorizeController;
use local_learnwise\local\OAuth2\OpenID\ResponseType\AuthorizationCode as OpenIDAuthorizationCodeResponseType;
use local_learnwise\local\OAuth2\OpenID\Storage\AuthorizationCodeInterface as OpenIDAuthorizationCodeInterface;
use local_learnwise\local\OAuth2\OpenID\GrantType\AuthorizationCode as OpenIDAuthorizationCodeGrantType;
use local_learnwise\local\OAuth2\Controller\AuthorizeControllerInterface;
use local_learnwise\local\OAuth2\Controller\AuthorizeController;
use local_learnwise\local\OAuth2\Controller\TokenControllerInterface;
use local_learnwise\local\OAuth2\Controller\TokenController;
use local_learnwise\local\OAuth2\ClientAssertionType\ClientAssertionTypeInterface;
use local_learnwise\local\OAuth2\ClientAssertionType\HttpBasic;
use local_learnwise\local\OAuth2\ResponseType\ResponseTypeInterface;
use local_learnwise\local\OAuth2\ResponseType\AuthorizationCode as AuthorizationCodeResponseType;
use local_learnwise\local\OAuth2\ResponseType\AccessToken;
use local_learnwise\local\OAuth2\ResponseType\JwtAccessToken;
use local_learnwise\local\OAuth2\OpenID\ResponseType\CodeIdToken;
use local_learnwise\local\OAuth2\OpenID\ResponseType\IdToken;
use local_learnwise\local\OAuth2\OpenID\ResponseType\IdTokenToken;
use local_learnwise\local\OAuth2\TokenType\TokenTypeInterface;
use local_learnwise\local\OAuth2\TokenType\Bearer;
use local_learnwise\local\OAuth2\GrantType\GrantTypeInterface;
use local_learnwise\local\OAuth2\GrantType\UserCredentials;
use local_learnwise\local\OAuth2\GrantType\ClientCredentials;
...
use local_learnwise\local\OAuth2\Storage\ClientInterface;
use local_learnwise\local\OAuth2\Storage\JwtAccessToken as JwtAccessTokenStorage;
use local_learnwise\local\OAuth2\Storage\JwtAccessTokenInterface;
    ...
    UserInfoControllerInterface
{
    ...
    protected $storageMap = array(
        ...
        'user_claims' => OpenID\Storage\UserClaimsInterface::class,
    ...
    protected $responseTypeMap = array(
        'token' => ResponseType\AccessTokenInterface::class,
        'code' => ResponseType\AuthorizationCodeInterface::class,
        'id_token' => OpenID\ResponseType\IdTokenInterface::class,
        'id_token token' => OpenID\ResponseType\IdTokenTokenInterface::class,
        'code id_token' => OpenID\ResponseType\CodeIdTokenInterface::class,
    );
